export const en = {
  ...
  settings: {
    ...
    shopLogo: "Shop Logo",
    shopLogosTitle: "Shop Logos (Up to 3 Logos)",
    shopLogosDesc: "Upload up to 3 different shop logos (e.g. Primary, Black/White, or Stamp) to use for vouchers and branding.",
    logoSlot1: "Logo 1 (Primary)",
    logoSlot2: "Logo 2",
    logoSlot3: "Logo 3",
    receiptLogoTitle: "Default Receipt Logo",
    receiptLogoDesc: "Choose which logo appears on customer receipts and vouchers printed from this device.",
    noReceiptLogo: "No Logo",
    defaultReceiptLogoSet: "Default receipt logo set to",
